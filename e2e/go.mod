...
require (
	...
	github.com/codeready-toolchain/api v0.0.0-20260305144020-4ff0e6b6e174 // indirect
	github.com/codeready-toolchain/toolchain-common v0.0.0-20260327164503-d25d8287eda7 // indirect
